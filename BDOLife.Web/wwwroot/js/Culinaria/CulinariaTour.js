$(document).ready(function () {
    ...
    function Tour() {
        ...
        tour.on('complete', () => {
            setCookie('tour-culinaria-disabled', true);
        });
        ...
        let steps = [
            {
                text: '<p>Este campo contém todas as receitas de culinária. Você pode pesquisar pelo nome da receita.</p>',
                attachTo: {
            ...
            },
            {
                text: '<p>Este campo deve conter a quantidade de receitas que deseja produzir.</p>' +
                    '<p>Dica: Procure usar o valor da durabilidade disponível do seu utensílio de culinária.</p>' +
            ...
            {
                text: '<p>Selecione sua maestria de culinária. Se a sua maestria for um número quebrado (Ex: 495) você deve selecionar um valor anterior que seja múltiplo de 50 (Ex: Selecione 450 e não 500).</p>' +
        ...
        let cookie = getCookie('tour-culinaria-disabled');
        if (cookie === null)
            tour.start();
    }
})