...
namespace BDOLife.Web.Migrations
{
    ...
    [Migration("20201204001459_maestrias-processo")]
    partial class maestriasprocesso
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BDOLife.Core.Entities.Colheita", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<string>("PlantaAltaQualidadeReferenciaId")
                        .HasColumnType("nvarchar(450)");

                    b.Property<string>("PlantaEspecialReferenciaId")
                        .HasColumnType("nvarchar(450)");

                    b.Property<string>("PlantaReferenciaId")
                        .IsRequired()
                        .HasColumnType("nvarchar(450)");

                    b.Property<string>("RegiaoIndicada")
                        .HasColumnType("nvarchar(max)");

                    b.Property<int>("Slot")
                        .HasColumnType("int");

                    b.Property<TimeSpan>("TempoComFertilizante")
                        .HasColumnType("time");

                    b.Property<TimeSpan>("TempoPerfeito")
                        .HasColumnType("time");

                    b.Property<long?>("ValorCaixa")
                        .HasColumnType("bigint");

                    b.Property<long?>("ValorSementeMagica")
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("PlantaAltaQualidadeReferenciaId")
                        .IsUnique()
                        .HasFilter("[PlantaAltaQualidadeReferenciaId] IS NOT NULL");

                    b.HasIndex("PlantaEspecialReferenciaId")
                        .IsUnique()
                        .HasFilter("[PlantaEspecialReferenciaId] IS NOT NULL");

                    b.HasIndex("PlantaReferenciaId")
                        .IsUnique();
            ...
            modelBuilder.Entity("BDOLife.Core.Entities.Item", b =>
                {
                    ...
                    b.Property<bool>("MultiResultados")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("BDOLife.Core.Entities.Node", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BDOLife.Core.Entities.Colheita", b =>
                {
                    b.HasOne("BDOLife.Core.Entities.Item", "Fruta")
                        .WithOne()
                    ...
                    b.HasOne("BDOLife.Core.Entities.Item", "PlantaAltaQualidade")
                        .WithOne()
                        .HasForeignKey("BDOLife.Core.Entities.Colheita", "PlantaAltaQualidadeReferenciaId")
                        .HasPrincipalKey("BDOLife.Core.Entities.Item", "ReferenciaId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("BDOLife.Core.Entities.Item", "PlantaEspecial")
                        .WithOne()
                        .HasForeignKey("BDOLife.Core.Entities.Colheita", "PlantaEspecialReferenciaId")
                        .HasPrincipalKey("BDOLife.Core.Entities.Item", "ReferenciaId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("BDOLife.Core.Entities.Item", "Planta")
                        .WithOne()
                        .HasForeignKey("BDOLife.Core.Entities.Colheita", "PlantaReferenciaId")
                        .HasPrincipalKey("BDOLife.Core.Entities.Item", "ReferenciaId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                });
