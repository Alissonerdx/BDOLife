...
namespace BDOLife.Application.Interfaces
{
    public interface IItemService
    {
        ...
        Task<IList<NodeViewModel>> TreeViewSubReceita(string raiz, string referenciaId, int quantidade, int quantidadePorReceita, decimal procNormal, decimal procRaro, bool semDetalhes = false);
